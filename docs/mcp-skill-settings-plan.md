...
| 日期       | 版本 | 变更                                                                                                                                                                                                                                                                                                                                                                                          |
| ---------- | ---- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-08-13 | v1.4 | 增强：对话区 MCP / Skill / Agent 三个选择器补「立即新增」入口（点击跳转系统设置对应 Tab，经 `app:open-settings` 全局事件 + AppShell 监听，复用 initialTab 定位机制）；确认 Skill 选择持久化（ChatPage 随对话落盘恢复，任务详情 Composer 为会话内状态，与 mcpService 一致）。                                                                                                                  |
