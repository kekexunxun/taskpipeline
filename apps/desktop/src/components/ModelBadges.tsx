    ...
    <span className={cn("inline-flex items-center gap-1", className)}>
      {model.isReasoning && (
        <span
          title="推理模型"
          aria-label="推理模型"
          className="inline-flex items-center gap-0.5 rounded bg-amber-500/15 px-1 text-[10px] font-medium text-amber-300"
        >
          <BrainIcon size={9} />
          推理
        </span>
      ...
      {model.isVl && (
        <span
          title="支持视觉/多模态输入"
          aria-label="支持视觉"
          className="inline-flex items-center gap-0.5 rounded bg-sky-500/15 px-1 text-[10px] font-medium text-sky-300"
        >
          <EyeIcon size={9} />
          视觉
        </span>
      ...
      {model.priceFactor !== undefined && model.priceFactor !== null && (
        <span
          ...
          className="inline-flex items-center gap-0.5 rounded bg-emerald-500/15 px-1 text-[10px] font-medium text-emerald-300"
        >
          <CoinsIcon size={9} />
