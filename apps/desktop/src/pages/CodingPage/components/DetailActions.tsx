...
export function DetailActions({
  ...
  return (
    <div className="flex min-h-10 shrink-0 items-center gap-1.5 border-b px-4 py-2">
      ...
      {!starting && !running && isValidating && (
        <Button size="sm" className="gap-1 px-2" onClick={onRetryValidation}>
      ...
      {!starting && !running && isValidationFailed && (
        <Button size="sm" className="gap-1 px-2" onClick={onRetryValidation}>
          <RefreshCcwIcon size={11} />
          重新校验
        </Button>
