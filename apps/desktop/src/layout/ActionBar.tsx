...
import { MessageSquareTextIcon, Code2Icon, type LucideIcon } from "lucide-react";
          ...
          <Tooltip key={to}>
            <TooltipTrigger asChild>
              ...
              >
                <span
                  className={cn(
                    "absolute left-0 top-2 bottom-2 w-[3px] rounded-r-full bg-primary transition-opacity",
