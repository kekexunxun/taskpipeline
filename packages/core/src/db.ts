...
export class TaskStore {
  ...
  createTask(input: Pick<Task, "title" | "description"> & Partial<Task>): Task {
    const task: Task = {
      ...
      commitMessage: input.commitMessage, piSessionPath: input.piSessionPath, qoderModel: input.qoderModel, sessionUsage: input.sessionUsage,
